...
class CLIPEnhancedYOLOEModel(YOLOEModel):
    ...
    def set_vocab(self, vocab, names):
        ...
        cv3 = getattr(
            head, "one2one_enhanced_cv3", 
            getattr(head, "enhanced_cv3",
                getattr(head, "one2one_cv3", head.cv3)
            )
        )
        ...
        for loc_head, cls_head in zip(head.cv2, getattr(head, "enhanced_cv3", head.cv3)):
